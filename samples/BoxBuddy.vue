...
const props = defineProps({
  /** One of: idle, happy, curious, angry, confused, sad, surprised, sleepy, wink, mega-hop */
  expression: {
    type: String,
    default: 'idle',
    validator: (value) => ["idle","happy","curious","angry","confused","sad","surprised","sleepy","wink","mega-hop"].includes(value),
  },
      ...
      <g class="avatar-squash">
        ...
        <g class="avatar-props">
          <g transform="translate(-55.8 -89.6)">
            <g class="avatar-prop avatar-prop--angry-steam1" opacity="0">
          ...
          <g transform="translate(55.8 -89.6)">
            <g class="avatar-prop avatar-prop--angry-steam2" opacity="0">
