...
export function defaultProject(): AvatarProject {
  return {
    ...
    // mirrored ear-nubs, rosy cheeks and big sparkly eyes. Deliberately uses
    // one of everything: gradient fill, behindBody + mirror parts, blush
    // overlay, pupil highlights — so the default doubles as a feature demo.
    body: {
      kind: 'blob',
      width: 196,
      height: 178,
